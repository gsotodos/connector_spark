...
public class MapredExpandOutputCommitter extends OutputCommitter {

  public static final Logger LOG = LoggerFactory.getLogger(
      "org.expand.spark.MapredExpandOutputCommitter");
  
  /**
   * Temporary directory name 
   */
  public static final String TEMP_DIR_NAME = 
    org.expand.spark.ExpandOutputCommitter.PENDING_DIR_NAME;
  public static final String SUCCEEDED_FILE_NAME = 
    org.expand.spark.ExpandOutputCommitter.SUCCEEDED_FILE_NAME;
  static final String SUCCESSFUL_JOB_OUTPUT_DIR_MARKER =
    org.expand.spark.ExpandOutputCommitter.SUCCESSFUL_JOB_OUTPUT_DIR_MARKER;
  ...
  private org.expand.spark.ExpandOutputCommitter wrapped = null;
  
  private org.expand.spark.ExpandOutputCommitter 
  getWrapped(JobContext context) throws IOException {
    if(wrapped == null) {
      wrapped = new org.expand.spark.ExpandOutputCommitter(
  ...
  Path getJobAttemptPath(JobContext context) {
    ...
    return out == null ? null : 
      org.expand.spark.ExpandOutputCommitter
  ...
  private Path getTaskAttemptPath(TaskAttemptContext context, Path out) throws IOException {
    ...
    if(workPath == null && out != null) {
      return org.expand.spark.ExpandOutputCommitter
